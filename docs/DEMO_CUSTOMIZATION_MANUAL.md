...
The JSON-based demo customization pipeline lets you quickly create custom demos in minutes.

Think of it as:
• **A data sheet** (customer profile)
• **A recommendation engine** (demo_customizer)
• **A story generator** (talk track)

Provide relevant inputs, sanity-check the outputs, and modify as needed.
